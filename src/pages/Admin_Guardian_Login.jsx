      ...
      <div className="max-w-md mx-auto px-6">
        ...
        <form onSubmit={(e) => onSubmit(e, "guardian")} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-[#e32626] hover:bg-red-700 py-3 rounded-lg text-base font-semibold shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 text-white"
          >
            {loading ? (
              <>
                <svg
