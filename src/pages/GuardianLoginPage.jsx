...
import { WifiOff, Eye, EyeOff } from "lucide-react";
...
const GuardianLoginForm = ({
  ...
  return (
    <div className="w-full h-full bg-[#2d2b5c] flex flex-col justify-center text-white px-10 py-8">
      <div className="max-w-sm mx-auto w-full">
        ...
        <form onSubmit={onSubmit} className="space-y-4">
          ...
          <button
            type="button"
            className="w-full bg-white rounded-lg py-2.5 px-4 flex items-center justify-center gap-3 hover:bg-gray-100 transition-all duration-200"
          >
