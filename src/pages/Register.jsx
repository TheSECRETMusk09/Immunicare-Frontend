...
const Register = () => {
  ...
  if (pendingVerification && !success) {
    return (
      <div className="min-h-screen min-h-[100dvh] flex items-center justify-center px-3 sm:px-4 py-3 sm:py-6 bg-gradient-to-br from-slate-700 via-slate-800 to-slate-900 overflow-y-auto modern-scrollbar">
