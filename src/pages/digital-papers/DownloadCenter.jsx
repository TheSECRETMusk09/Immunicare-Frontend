        ...
        <div className="flex">
          ...
          <div className="ml-3">
            ...
            <div className="mt-2 text-sm text-yellow-700 dark:text-yellow-300">
              <p>
                You do not have permission to access the admin download center.
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card title="Immunization Records">
            <p className="text-gray-500 mb-4">
              Download patient immunization records
            </p>
            <Button variant="primary">Download</Button>
          </Card>
          <Card title="Vaccination Certificates">
            <p className="text-gray-500 mb-4">
          ...
          <Card title="Monthly Reports">
            <p className="text-gray-500 mb-4">
              Download monthly summary reports
            </p>
            <Button variant="primary">Download</Button>
          </Card>
        </div>
